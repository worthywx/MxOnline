...
class Course(models.Model):
    ...
    teacher_tell = models.CharField(default="", verbose_name=u"老师告诉你能学到什么", max_length=300)
...
class CourseResource(models.Model):
    ...
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
    download = models.FileField(upload_to="course/resource/%Y/%m", verbose_name=u"上传路径")
